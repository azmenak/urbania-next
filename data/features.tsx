export const description = (
  <>
    <p>
      Urbania Sublime Engineered Hardwood Floors are designed for The Discerning
      Wood Flooring Consumer who demands both uncompromising Form and
      Functionality.
    </p>
    ...
    <p>
      ...
      state-of- the-art German engineered precision manufacturing process. As a
      ...
      finishing specialists work on a plank-by-plank basis to craft a product of
      superior quality and enduring beauty.
    </p>
    <p>
      The finishes of the Urbania Sublime collection were chosen to be a tool in
      the hands of the Interior Design Professional as well as those individuals
      with the talent and creativity to create their own beautiful spaces. We
      strive to offer a foundational element within your design scheme that
      enables the creation of unique, harmonious and aesthetically pleasing
      interior environments and spaces.
    </p>
  </>
);

export const features: Array<{ img: string; body: string }> = [
  {
    img: "cross-grain",
    body:
  ...
  },
  {
    img: "wear-layer",
    body:
      "3.5 mm of Dry Sawn hardwood offers 100% of the service life of solid hardwood flooring."
  }
];
